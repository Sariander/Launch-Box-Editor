      ...
      <template v-else-if="item.type == 'dropdown'">
        <div class="md-layout md-alignment-center-center">
          ...
          <md-field class="md-layout-item skinny-dropdown">
            <md-select v-if="editor" v-on:click.stop="stopEvent" v-on:md-selected="onDropdownClicked" :name="item.header" :id="item.header" v-model="activeLanguageCode">
              <md-option v-for="subItem of item.optionValues" :key="subItem['.key']" :value="subItem" :disabled="editor && !editor.languages[subItem].read">{{ isoLangs[subItem].nativeName }} ({{ isoLangs[subItem].name }})</md-option>
            </md-select>
          </md-field>
        </div>
      </template>
...
export default {
  ...
  methods: {
    onRowClicked () {
      this.$emit('row-clicked', this.item.sectionName, this.item['.key'], this.item.type)
    },
    onDropdownClicked () {
