      ...
      <template v-else-if="item.type == 'dropdown'">
        <div class="md-layout md-alignment-center-center">
          ...
          <md-field class="md-layout-item skinny-dropdown">
            <md-select v-on:click.stop="stopEvent" v-on:md-selected="onDropdownClicked" :name="item.header" :id="item.header" v-model="activeLanguageCode">
...
export default {
  ...
  methods: {
    onRowClicked () {
      this.$emit('row-clicked', this.item.sectionName, this.item['.key'])
    },
    onDropdownClicked () {
